...
{
    /// <summary>
    /// Basically a copy of ObservableObject from MVVM Light, but with [Serializable] added.
    /// This is inherited from in place of ViewModelBase when the object needs to be serializable
    /// </summary>
    [Serializable]
